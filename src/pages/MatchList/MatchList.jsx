...
export default function MatchList() {
  ...
  useEffect(() => {
    document.title = "SportStake - Match List";
          ...
          <Table className="table">
            ...
            <TableBody>
              {matchData.map((data, index) => (
                <TableRow key={index} onClick={() => navToDetails(data.id)}>
                  <TableCell
                    sx={{ color: "white", fontSize: 14, fontWeight: 400 }}
                  >
                    <div>{data.date}</div> {data.time}{" "}
                  </TableCell>
                  <TableCell
                    className="matchCell"
                    sx={{
                  ...
                  <TableCell
                    sx={{ color: "orange", fontSize: 18, fontWeight: 400 }}
                  >
                    {data.tie}
                  </TableCell>
                  <TableCell
